...
const translations = {
  ...
  'recipe.products': { fr: 'produit(s) proposé(s)', en: 'suggested product(s)' },
  ...
  'recipe.total': { fr: 'Total des produits proposés', en: 'Suggested products total' },
  'recipe.totalHelp': { fr: 'Hors produits manquants. Le panier existant est conservé.', en: 'Excludes missing products. Your existing basket is kept.' },
