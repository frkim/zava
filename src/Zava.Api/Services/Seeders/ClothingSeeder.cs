...
public static class ClothingSeeder
{
    public static List<Category> GenerateCategories()
    {
        return new List<Category>
        {
            ...
            new() { Id = 4, Name = "Pantalons & Jeans Homme", NameEn = "Men's Trousers & Jeans", Description = "Jeans, chinos, joggers et shorts", DescriptionEn = "Jeans, chinos, joggers and shorts", ProductCount = 10, SiteType = SiteType.Clothing, Icon = "Man2" },
