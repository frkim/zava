...
try
{
    ...
    Console.WriteLine("PASS: HTTP bounds/config, two agents, strict schema, price authority, preview, concurrent idempotency, variants, selective commit, never-suggest-again exclusions, staple flags, stock atomicity, stale reset, preference, timeout and quota.");
}
finally
{
